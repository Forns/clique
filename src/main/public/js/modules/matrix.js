...
(function () {
  ...
  // So like... basically, this isn't used anywhere, and I don't know
  // enough to name it better or tell you what it does... however, I can
  // tell you that it works, and was tested, and can be used as an alternative
  // to computing the Johnson Graphs as the server does for Clique
  // [!] Probably server side only
