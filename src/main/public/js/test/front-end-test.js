...
$(function () {
  ...
  test("Matrix: augment", function () {
    ok($M().augment($M()).equal($M()));
    ok($M().augment($M([[1]])).equal($M([[1]])));
    ok($M().augment($M([
      [1, 2, 3]
    ])).equal($M([
      [1, 2, 3]
  ...
  test("eig", function () {
    ...
    ok(result1[1].equal($M([
      [ 0.5000,  0.7071,  0.5000],
      [-0.7071,  0.0000,  0.7071],
      [ 0.5000, -0.7071,  0.5000]
    ])));
    
    ok(result2[0].equal($V([
      -5.1312,
      -0.1281,
       3.6780,
      11.5812
    ])));
    ok(result2[1].equal($M([
      [ 0.1077, -0.8289, -0.5441,  0.0710],
      [-0.3304,  0.4675, -0.7286,  0.3757],
      [ 0.6178,  0.0488,  0.1485,  0.7706],
      [-0.7053, -0.3029,  0.3883,  0.5098]
    ])));
  });
  ...
  test("gatherProjections", function () {
    var inputL1 = $M([
        ...
        result1 = Matrix.gatherProjections(inputL1, inputP1);
    ...
    ok(result1[1].equal($S(0, 0,
      [4, 1, 0.9027], [7, 1, 0.9448], [9, 1, 0.4909],
      [12, 1, 0.4893], [18, 1, 0.3377], [20, 1, 0.9001],
      [27, 1, 0.3692], [37, 1, 0.1112], [40, 1, 0.7803],
      [41, 1, 0.3897]
    )));
  });
  ...
  test("eigenspaceProjections", function () {
    var inputL1 = $S(0, 0,
        ...
        inputP3 = Matrix.full($S(0, 0,
          [9, 1, -9.3333], [17, 1, 1.6667], [24, 1, 7.6667],
          [9, 2, 9.3333], [17, 2, 9.3333], [24, 2, 9.3333],
          [30, 2, 75], [42, 2, 4], [44, 2, 301], [45, 2, 19]
        )),
        inputL3 = Matrix.full($S(0, 0,
